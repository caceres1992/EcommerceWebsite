        ...
        <div className='pt-24 px-5 xl:px-0 bg-sky-50'>
            <div className='flex   justify-center md:justify-between gap-20  flex-col lg:flex-row items-center max-w-7xl mx-auto'>
                <div className='flex-1 text-center md:text-left'>
                    ...
                    <p className=' text-center md:text-left my-6 text-gray-500 text-sm md:text-sm '>
                    ...
                    <button className='bg-sky-600 text-gray-50 py-2.5 px-10 shadow-sm rounded-xl hover:bg-sky-500'>Shop Now</button>
                </div>
