...
const DealOfTheDay = () => {
    return (
        ...
        <div className='  py-10 text-center'>
            ...
            <p className='w-[500px] text-center mx-auto mt-4 text-sm text-gray-500'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam neque, ducimus facere incidunt, commodi fugiat.l
            </p>
            <div className='bg-sky-100'>
                <div className='my-20 max-w-7xl mx-auto px-5  py-10 flex justify-between items-center gap-x-20'>
                    ...
                    <img src={'./assets/people.png'} className=" h-[400px] flex-1 p-2 "/>
                </div>
            </div>
