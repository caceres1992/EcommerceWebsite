...
const NewWinterCollection = ({ products }) => {
    return (
        <div className=' max-w-7xl mx-auto py-10 px-5 text-center'>
            ...
            <p className=' max-w-[500px] text-center mx-auto mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam neque, ducimus facere incidunt, commodi fugiat.l</p>
