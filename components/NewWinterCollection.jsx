...
const NewWinterCollection = ({ products }) => {
    return (
        <div className=' max-w-7xl mx-auto py-10 px-5 text-center'>
            ...
            <button className=' px-10 py-2 rounded-md text-gray-900 flex items-center mx-auto gap-x-1 hover:text-orange-400 transition-all '>View more <BiRightArrowAlt size={20} /></button>
        </div>
    )
}
